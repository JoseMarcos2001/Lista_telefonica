...
public class MainActivity extends AppCompatActivity {
    ...
    EditText data;
    ListView listagem;
    List<br.unigran.listatelefonica.listaTelefonica.Contato> dados;
    DBHelper db;
    ContatoDB contatoDB;
    Integer atualiza;
    ...
    public void salvar(View view) {
        if (verificar()) {
            br.unigran.listatelefonica.listaTelefonica.Contato contato = new br.unigran.listatelefonica.listaTelefonica.Contato();
            if (atualiza != null) {
